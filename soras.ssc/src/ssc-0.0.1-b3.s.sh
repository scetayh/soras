...
export ssc_processname="$0"
export ssc_version=0.0.1-b3
...
## 5 打印版本 >>>
echo "$ssc_processname-$ssc_version (Soras Shell Compiler)
...
## compiler: $ssc_processname-$ssc_version
## host: $(uname -a)
...
## 12 修改权限和所有者 >>>
chmod +rwx "$ssc_target"
chown -R "$USER" "$ssc_target"
## <<<